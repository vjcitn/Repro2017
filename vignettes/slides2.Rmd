...
- itntrialshare.org -- we will see how figures in NEJM online can bridge to data and R code
- github.com/vjcitn/barca -- we will fork this package, make changes, and witness continuous integration
